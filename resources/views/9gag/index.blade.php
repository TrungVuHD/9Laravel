  ...
  @foreach($posts as $post)
    <div class="home-item" data-post-id="{{ $post->id }}">
      ...
      <div class="social-section">
        ...
        <a href="{{ url('posts'.'/'.$post->slug.'#comments') }}" class="comment social-item">
  ...
  <script id="home-item-template" type="x-tmpl-mustache">
    @{{#posts}}
      <div class="home-item" data-post-id="@{{ id }}">
        ...
        <a class="gif-wrapper-link" href="{{ url('posts') }}/@{{slug) }}">
          <h3 class="title">@{{ title }}</h3>
          <div class="gif-wrapper">
            <div class="gif-text">
              GIF
        ...
        <div class="social-section">
          ...
          <a href="{{ url('posts') }}/@{{ slug }}#comments" class="comment social-item">
            <i class="fa fa-comment" aria-hidden="true"></i>
          </a>
          <div class="pull-right">
